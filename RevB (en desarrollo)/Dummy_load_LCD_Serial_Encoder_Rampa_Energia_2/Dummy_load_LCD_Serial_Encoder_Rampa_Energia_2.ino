...
long double tiempo5,Itotal=0,Vtot,Temperatura;                                                                 //Tiempo con signo para la rampa
#define PIN_INPUT 2                                                                  //Entrada del sensor de temperatura
#define PIN_OUTPUT 2                                                                 //Salida PWM para el cooler
...
unsigned long tiempo,tiempo2,tiempo4,Time,tiempo3,muestras,tiempo6,Treset=0;                                  //Tiempos varios
...
void serial()
{
  ...
  Serial.print(P);
  Serial.print(" W     ");
  Serial.print(float(Temperatura));
  Serial.print(" C     ");
  Serial.print(Rset);
  Serial.print(" Ohms   ");
  Serial.print(Iset);
